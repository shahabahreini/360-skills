...
Run this skill during execution of a task, not as a separate report generator. Its job is to reduce token waste while preserving the same correctness, completeness, and usability the task would have without this skill.
