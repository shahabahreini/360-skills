...
rejects('extra frontmatter field', root => edit(root, BLUEPRINT, t => t.replace('version: 2.0.0', 'version: 2.0.0\nmetadata: extra')), /extra frontmatter/);
rejects('duplicate frontmatter key', root => edit(root, BLUEPRINT, t => t.replace('version: 2.0.0', 'version: 2.0.0\nversion: 2.0.0')), /duplicate frontmatter/);
rejects('missing frontmatter field', root => edit(root, BLUEPRINT, t => t.replace('version: 2.0.0\n', '')), /missing frontmatter field/);
...
rejects('semver leading zero', root => edit(root, BLUEPRINT, t => t.replace('version: 2.0.0', 'version: 02.0.0')), /not valid semver/);
rejects('semver leading-zero prerelease', root => edit(root, BLUEPRINT, t => t.replace('version: 2.0.0', 'version: 2.0.0-01')), /not valid semver/);
...
rejects('wrong README version', root => edit(root, 'README.md', t => t.replace(/(^\| \[`360-blueprint`\].+)\| 2.0.0 \|/m, '$1| 9.0.0 |')), /version drift/);
